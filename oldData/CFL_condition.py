...
import numpy as np
from ideal_hydro_functions_NR import soundSpeed_NR
from ideal_hydro_functions_SR import soundSpeed_SR


def CFLcondition_NR(grid,fluid,eos,aux):
      
    #sound speed calculation for whole domain
    sound = soundSpeed_NR(fluid.dens, fluid.pres, eos)
...
def CFLcondition_SR(grid,fluid,eos,aux):
      
    #sound speed calculation for whole domain
    sound = soundSpeed_SR(fluid.dens, fluid.pres, eos)
